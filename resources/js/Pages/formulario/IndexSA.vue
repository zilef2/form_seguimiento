...
<!--                                        <ChevronUpDownIcon class="w-4 h-4" />-->
                ...
                <div v-if="props.totalValorUnitario < 0" class="border border-blue-300 shadow rounded-md p-4 max-w-sm w-full mx-auto">
                ...
                <p v-else class="whitespace-nowrap py-4 px-2 sm:py-3 text-center font-bold text-lg">Costo total: {{ plata_format(props.totalValorUnitario) }}</p>
                <!--                    v-if="props.total"-->
