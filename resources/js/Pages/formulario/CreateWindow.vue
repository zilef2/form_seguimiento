            ...
            <div class="flex-wrap mx-auto px-1 sm:px-6 lg:px-8 gap-8">
                <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 md:p-10 lg:p-12">
                    ...
                    <form class="space-y-6">
                        <TextAreaZilef v-model:valor="form.necesidad"
                            placeholder="Describa aqui su " nombre="necesidad"/>
                        <TextAreaZilef v-model:valor="form.justificacion"
                            placeholder="Describa aqui su " nombre="justificacion"/>
                        <TextAreaZilef v-model:valor="form.actividad"
                            placeholder="Describa aqui su " nombre="actividad"/>
...
<!--                            <InputError class="mt-2" :message="form.errors.proceso_que_solicita_presupuesto"/>-->
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                name="file"
                                type="file"
                                class="hidden w-full px-3 py-2 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                            />
                        </div>
                        <div>
                            <button
